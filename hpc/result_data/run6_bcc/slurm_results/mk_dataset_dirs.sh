...
declare -a datasets_new=("chess" "ego-facebook" "elec" "email-EuAll" "epinions" "facebook-combined" "linux" "pajek-erdos" "slashdot-threads" "slashdot-zoo" "sx-mathoverflow" "topology" "wikispeedia" "parallels")
