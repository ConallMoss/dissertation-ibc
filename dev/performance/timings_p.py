...
if __name__ == "__main__":
    ...
    # bce_initial = defaultdict(float)
    # s = time.perf_counter()
    # x, pid_work = iCentral_p(G, bce_initial, e, PROCESSES=32)
    # print(pid_work)
    # print("Real time Parallel iCentral:")
    # print(time.perf_counter() - s)
    ...
    # bce_initial = defaultdict(float)
    # s = time.perf_counter()
    # x, pid_work = iCentral_p(G, bce_initial, e, PROCESSES=8)
    # print(pid_work)
    # print("Real time Parallel iCentral:")
    # print(time.perf_counter() - s)
    ...
    # bce_initial = defaultdict(float)
    # s = time.perf_counter()
    # x, pid_work = iCentral_p(G, bce_initial, e, PROCESSES=4)
    # print(pid_work)
    # print("Real time Parallel iCentral:")
    # print(time.perf_counter() - s)
    ...
    # bce_initial = defaultdict(float)
    # s = time.perf_counter()
    # x, pid_work = iCentral_p(G, bce_initial, e, PROCESSES=2)
    # print(pid_work)
    # print("Real time Parallel iCentral:")
    # print(time.perf_counter() - s)
